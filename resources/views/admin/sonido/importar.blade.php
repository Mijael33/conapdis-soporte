...
@section('title', 'Importar Equipos de Sonido')
@section('page-title', 'Importar Equipos de Sonido desde Excel')
@section('content')
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.sonido.procesar-importacion') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
