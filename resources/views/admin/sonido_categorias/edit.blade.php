...
@section('title', 'Editar Categoría de Sonido')
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.sonido-categorias.update', $categoria) }}" method="POST">
            @csrf @method('PUT')
            <div class="mb-3">
            ...
            <a href="{{ route('admin.sonido-categorias.index') }}" class="btn-outline-conapdis">Cancelar</a>
        </form>
    </div>
</div>
@endsection