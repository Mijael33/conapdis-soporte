...
<?php if(session('importacion_resumen')): ?>
<?php $resumen = session('importacion_resumen'); ?>

<div id="modalImportOverlay">
    <div class="modal-import-content">

        
        <div class="p-3 text-white <?php echo e($resumen['tiene_errores'] ? 'bg-warning' : 'bg-success'); ?>" style="border-radius: 16px 16px 0 0;">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold">
                    <i class="bi bi-<?php echo e($resumen['tiene_errores'] ? 'exclamation-triangle-fill' : 'check-circle-fill'); ?> me-2"></i>
        ...
        <div class="p-4">
            ...
            <div class="text-center mb-4">
                ...
                <h4 class="fw-bold" style="color: #001e5c;"><?php echo e(strtoupper($resumen['modulo'])); ?></h4>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-3 h-100" style="border-left: 4px solid #003097 !important;">
                        <div class="card-body text-center py-3">
                            ...
                            <h3 class="fw-bold mb-0" style="color: #003097;"><?php echo e($resumen['total_procesados']); ?></h3>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-3 h-100" style="border-left: 4px solid #4c7f36 !important;">
                        <div class="card-body text-center py-3">
                            ...
                            <h3 class="fw-bold mb-0" style="color: #4c7f36;"><?php echo e($resumen['importados']); ?></h3>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-3 h-100" style="border-left: 4px solid #ef172f !important;">
                        <div class="card-body text-center py-3">
                            ...
                            <h3 class="fw-bold mb-0" style="color: #ef172f;"><?php echo e($resumen['fallidos']); ?></h3>
        ...
        <div class="p-3 bg-light d-flex justify-content-between" style="border-radius: 0 0 16px 16px;">
            ...
            <?php if($resumen['tiene_errores'] && $resumen['archivo_errores'] && $rutaDescarga): ?>
            <a href="<?php echo e(route($rutaDescarga, $resumen['archivo_errores'])); ?>" class="btn btn-conapdis rounded-pill px-4">
...
<?php endif; ?><?php /**PATH C:\Users\CONAPDIS\Desktop\conapdis-soporte-main\resources\views/components/modal-resultado-importacion.blade.php ENDPATH**/ ?>