<?php $__env->startSection('title', 'Importar Componentes'); ?>
<?php $__env->startSection('page-title', 'Importar Componentes desde Excel'); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="alert alert-info">
            ...
            <div class="mt-2">
                <a href="<?php echo e(route('admin.componentes.plantilla')); ?>" class="btn btn-sm btn-outline-conapdis">
                    <i class="bi bi-download"></i> Descargar Plantilla de Ejemplo
                </a>
            </div>
        </div>

        <form action="<?php echo e(route('admin.componentes.procesar-importacion')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('admin.componentes.index')); ?>" class="btn-outline-conapdis">Cancelar</a>
        </form>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CONAPDIS\Desktop\conapdis-soporte-main\resources\views/admin/componentes/importar.blade.php ENDPATH**/ ?>